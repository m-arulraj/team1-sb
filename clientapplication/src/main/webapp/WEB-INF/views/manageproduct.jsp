...
<body class="w3-light-grey">
	...
	<nav class="w3-sidebar w3-collapse w3-white w3-animate-zoom"
		...
		<div class="w3-bar-block">
			...
			<a href="/manageproduct" class="w3-bar-item w3-button w3-padding "><i
				class="fa fa-user-plus fa-fw"></i>&nbsp; Manage Product</a>
			<!-- <a href="/biller"
				class="w3-bar-item w3-button w3-padding"><i
				class="fa fa-user-plus fa-fw"></i>&nbsp; Add Biller</a> -->
			<a href="viewstockmanager" class="w3-bar-item w3-button w3-padding"><i
		...
		<div class="w3-row-padding w3-margin-bottom">
			<div class="w3-quarter">
				<div class="w3-container w3-red w3-padding-16">
					<a href="/addproduct" class="w3-bar-item w3-button"><i
          ...
          <h3>52</h3>
			...
			<div class="w3-quarter">
				<div class="w3-container w3-teal w3-padding-16">
					<div class="w3-left">
						<a href="/deleteproduct" class="w3-bar-item w3-button"><i
							class="fa fa-trash" style="font-size: 48px; color: black"></i></a>
					</div>
					<!-- <div class="w3-right">
						<h3>23</h3>
					</div> -->
