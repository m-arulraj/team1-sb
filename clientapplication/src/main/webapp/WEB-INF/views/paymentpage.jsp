			...
			<div class="col-75">
				<div class="container">
					<form action="/action_page.php">
						...
						<div class="row">
							<div class="col-50">
								...
								<input type="text" id="fname" name="firstname"
									placeholder="Biller name"> <label for="email"><i
									class="fa fa-envelope"></i> Email</label> <input type="text" id="email"
									name="email" placeholder="john@example.com"> <label
									for="adr"><i class="fa fa-address-card-o"></i> Contact Number</label>
								<input type="text" id="adr" name="address"
									> <label for="city"><i
									class="fa fa-shopping-cart"></i> Product Billing</label> <input type="text"
						...
						</label> --><input type="submit" value="Genrate Bill " class="btn"> 
					</form>
				</div>
			</div>
