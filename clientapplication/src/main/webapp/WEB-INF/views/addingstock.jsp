...
<body>
	...
	<div class="container">
		<form:form action="/addstocktotable" align="center"
			modelAttribute="stockdetails">
			...
			<label for="quantity">CostPrice/product</label>
			<input type="number" name="costPrice" value="0">
			&emsp;&emsp;
			<label for="quantity">SellingPrice</label>
			<input type="number" name="sellingPrice" value="0">
			<br>

			<label for="quantity">Discount</label>
			<input type="number" name="discount" value="0">
			&emsp;&emsp;
			<label for="quantity">GST</label>
			<input type="number" name="gst" value="0">
			<br>

			<label for="quantity">TotalCostPrice</label>
			<input type="number" name="totalCp" value="0">
			&emsp;&emsp;
